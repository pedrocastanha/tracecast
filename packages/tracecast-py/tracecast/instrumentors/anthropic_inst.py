...
class AnthropicInstrumentor(BaseInstrumentor):
    ...
    def patch(self) -> None:
        ...
        # Async
        if hasattr(mod, "AsyncMessages"):
            self._original_acreate = mod.AsyncMessages.create
            ...
            mod.AsyncMessages.create = patched_acreate
    ...
    def _capture(self, client_self: Any, args: tuple, kwargs: dict, original_fn: Any, trace: Any) -> Any:
        ...
        span.output = truncate_payload(extract_content(response, "anthropic"))
        trace.spans.append(span)
